                        ...
                        <div class="row" data-aos="fade-up">
                            <div class="col-md-12 text-center">
                                <div class="site-block-27">
                                    ...
                                    <ul>
                                        <li><a href="<?php echo $route->generateURL('Producto','catalogo')?>?fecha_inicial=<?php echo $paginacion->getFecha('fecha_inicial'); ?>&fecha_final=<?php echo $paginacion->getFecha('fecha_final'); ?>&page=<?php echo $_GET['pg']<=0 ? $paginacion->getPagina()-1:'1';?>"><</a></li>
                                        <?php for ($i = 1; $i<=$paginacion->getNumPaginas();$i++){?>
