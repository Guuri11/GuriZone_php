    ...
    <div class="site-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <?php if($_COOKIE[$cookieName] === "admin"){     // SI EL USUARIO ES ADMIN: OPCION EDITAR PRODUCTO?>
                        <p><a href="?page=editar_producto&id=<?php echo $productoSeleccionado->getIdProd();?>" class="buy-now btn btn-sm btn-primary">EDITAR</a></p>
                    <?php } ?>
                </div>
            </div>
            </div>
